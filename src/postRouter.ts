...
const joinUserForm = `SELECT P.POST_ID, P.POST_CLASSIFY, U.STUDENT_NUM, P.PUBLISHER_ID, U.USER_NAME, U.USER_INTRO, U.IMAGE, P.IMAGES, P.TITLE, P.BODY, P.GOOD, P.BAD, P.POST_DATE, P.MARKER, P.TAG, P.COMMENT_COUNT, to_char(P.REGIT_DATE AT TIME ZONE 'UTC', 'yy/mm/dd hh24:mi')
FROM POSTS P JOIN USERS U 
ON (P.PUBLISHER_ID = U.USER_ID)`;
const joinUserFormForSimple = `SELECT P.POST_ID, P.POST_CLASSIFY, P.PUBLISHER_ID, U.USER_NAME, U.USER_INTRO, U.IMAGE, P.TITLE, P.BODY, P.GOOD, P.BAD, P.POST_DATE, P.MARKER, P.TAG, P.COMMENT_COUNT, to_char(P.REGIT_DATE AT TIME ZONE 'UTC', 'yy/mm/dd hh24:mi')
FROM POSTS P JOIN USERS U 
ON (P.PUBLISHER_ID = U.USER_ID)`;
const pageRowNum = 10;
