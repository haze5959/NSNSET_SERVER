...
const selectColums = ` USER_NAME, USER_ID, USER_INTRO, STUDENT_NUM, to_char(RECENT_DATE AT TIME ZONE 'UTC', 'yy/mm/dd hh24:mi'), IMAGE, SUBIMAGE, POINT, USER_DESC, USER_COGNITO_SUB, BIRTHDAY, GENDER`;
